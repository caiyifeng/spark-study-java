...
public class MedicinalInfoMerger {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
    	...
    	methodMap.put(2, "setIcdCategory");
    	methodMap.put(3, "setIcdLiability");
    	methodMap.put(4, "setIcdRisk");
    	methodMap.put(5, "setIcdAccident");
    	methodMap.put(6, "setIcdDisease");
    	...
    	methodGetMap.put(2, "getIcdCategory");
    	methodGetMap.put(3, "getIcdLiability");
    	methodGetMap.put(4, "getIcdRisk");
    	methodGetMap.put(5, "getIcdAccident");
    	methodGetMap.put(6, "getIcdDisease");
...
//		final Field[] flds = HospitalInfo.class.getDeclaredFields();
		...
		JavaRDD<String> hospitalInfoRDD = sc.textFile("hdfs://iZ113mzdkz0Z:9000/user/caiyf/medicinal/medicinal-info.txt");
...
//		}			
//		
		lineRDD.saveAsTextFile("hdfs://iZ113mzdkz0Z:9000/user/caiyf/medicinal_merge");
